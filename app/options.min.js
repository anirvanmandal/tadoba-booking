...
const storeInfo = () => {
  chrome.storage.sync.set({
    tatkalInfo: tatkalInfo,
    passengerInfo: passengerInfo,
    activitiesInfo: activitiesInfo
  }, () => {
    jquery__WEBPACK_IMPORTED_MODULE_1___default()('.settings-saved-callout').removeClass('hidden');
    jquery__WEBPACK_IMPORTED_MODULE_1___default()('#save-options').html('Save');
    setTimeout(() => {
      jquery__WEBPACK_IMPORTED_MODULE_1___default()('.settings-saved-callout').addClass('hidden');
    }, 2000);
  });
};
...
const initializeTabs = () => {
  return new foundation_sites__WEBPACK_IMPORTED_MODULE_0__.Tabs(jquery__WEBPACK_IMPORTED_MODULE_1___default()('.js-vertical-tabs'), {});
};
